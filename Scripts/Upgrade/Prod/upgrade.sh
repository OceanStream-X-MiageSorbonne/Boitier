...
wget -O /home/pi/OceanBox/updater/MetaLatestOceanBox1.xml "http://devops.oceanstream.fr:8081/nexus/service/local/artifact/maven/resolve?g=oceanbox&a=OceanBox&v=LATEST&r=OceanBoxReleases&e=jar"
...
then
        ...
        rm -f "/home/pi/OceanBox/updater/MetaLatestOceanBox1.xml"
