...
wget -O /home/pi/OceanBox/updater/MetaLatestOceanBox.xml "http://devops.oceanstream.fr:8081/nexus/service/local/artifact/maven/resolve?g=oceanbox&a=OceanBox&v=LATEST&r=DevOceanBoxReleases&e=jar"
